...
public class CRC {
	...
	public static class Parameters {
		 ...
		 * package.
		 */
		public static final Parameters Castagnoli = new Parameters(32, 0x1EDC6F41L, 0x00FFFFFFFFL, true, true,
				0x00FFFFFFFFL);
		/** CRC32C is an alias to Castagnoli */
		public static final Parameters CRC32C = Castagnoli;
		/** Koopman polynomial */
		public static final Parameters Koopman = new Parameters(32, 0x741B8CD7L, 0x00FFFFFFFFL, true, true,
				0x00FFFFFFFFL);

		/** CRC64ISO is set of parameters commonly known as CRC64-ISO */
		public static final Parameters CRC64ISO = new Parameters(64, 0x000000000000001BL, 0xFFFFFFFFFFFFFFFFL, true,
				true, 0xFFFFFFFFFFFFFFFFL);
		/** CRC64ECMA is set of parameters commonly known as CRC64-ECMA */
		public static final Parameters CRC64ECMA = new Parameters(64, 0x42F0E1EBA9EA3693L, 0xFFFFFFFFFFFFFFFFL, true,
				true, 0xFFFFFFFFFFFFFFFFL);
	 ...
	 * (using init, update and finalCRC methods, possibly supplying data in chunks).
	 * It can be called multiple times per CRC calculation to feed data to be
	 * processed in chunks.
	 * 
	 * @param curValue CRC intermediate value so far
	 * @param chunk    data chunk to b processed by this call
	 * @param offset   is 0-based offset of the data to be processed in the array
	 *                 supplied
	...
	/**
	 * This method should be called to retrieve actual CRC for the data processed so
	 * far.
	 * 
	 * @param curValue CRC intermediate value so far
	...
	/**
	 * Constructs a new CRC processor for table based CRC calculations. Underneath,
	 * it just calls finalCRC() method.
	 * 
	 * @param crcParams CRC algorithm parameters
	 */
	 ...
	 * every time this package is used. Underneath, it just calls finalCRC() method.
	 * 
